...
namespace CollegeFootballData.Models
{
    ...
    public partial class TeamSeasonPlayerPpaValues : IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::CollegeFootballData.Models.TeamSeasonPlayerPpaValues"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::CollegeFootballData.Models.TeamSeasonPlayerPpaValues CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::CollegeFootballData.Models.TeamSeasonPlayerPpaValues();
        }
        /// <summary>
