...
namespace CollegeFootballData.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/5.6.3/csharp");
            BasePath = "https://apinext.collegefootballdata.com";
        ...
        public Configuration(
            ...
            string basePath = "https://apinext.collegefootballdata.com") : this()
        {
        ...
        {
            string report = "C# SDK (CollegeFootballData) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 5.6.3\n";
