...
namespace CollegeFootballData.Model
{
    ...
    /// ConferenceSPOffense
    /// </summary>
    [DataContract(Name = "ConferenceSP_offense")]
    public partial class ConferenceSPOffense : IValidatableObject
    {
        ...
        public ConferenceSPOffense(double? pace = default(double?), double? runRate = default(double?), double? passingDowns = default(double?), double? standardDowns = default(double?), double? passing = default(double?), double? rushing = default(double?), double? explosiveness = default(double?), double? success = default(double?), double rating = default(double))
        {
            // to ensure "pace" is required (not null)
            if (pace == null)
            {
                throw new ArgumentNullException("pace is a required property for ConferenceSPOffense and cannot be null");
            }
            this.Pace = pace;
            // to ensure "runRate" is required (not null)
            if (runRate == null)
            {
                throw new ArgumentNullException("runRate is a required property for ConferenceSPOffense and cannot be null");
            }
            this.RunRate = runRate;
            // to ensure "passingDowns" is required (not null)
            if (passingDowns == null)
            {
                throw new ArgumentNullException("passingDowns is a required property for ConferenceSPOffense and cannot be null");
            }
            this.PassingDowns = passingDowns;
            // to ensure "standardDowns" is required (not null)
            if (standardDowns == null)
            {
                throw new ArgumentNullException("standardDowns is a required property for ConferenceSPOffense and cannot be null");
            }
            this.StandardDowns = standardDowns;
            // to ensure "passing" is required (not null)
            if (passing == null)
            {
                throw new ArgumentNullException("passing is a required property for ConferenceSPOffense and cannot be null");
            }
            this.Passing = passing;
            // to ensure "rushing" is required (not null)
            if (rushing == null)
            {
                throw new ArgumentNullException("rushing is a required property for ConferenceSPOffense and cannot be null");
            }
            this.Rushing = rushing;
            // to ensure "explosiveness" is required (not null)
            if (explosiveness == null)
            {
                throw new ArgumentNullException("explosiveness is a required property for ConferenceSPOffense and cannot be null");
            }
            this.Explosiveness = explosiveness;
            // to ensure "success" is required (not null)
            if (success == null)
            {
                throw new ArgumentNullException("success is a required property for ConferenceSPOffense and cannot be null");
            }
