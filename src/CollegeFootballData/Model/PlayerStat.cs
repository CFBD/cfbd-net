...
namespace CollegeFootballData.Model
{
    ...
    public partial class PlayerStat : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerStat(int season, string playerId, string player, string position, string team, string conference, string category, string statType, string stat)
        {
            Season = season;
            PlayerId = playerId;
            Player = player;
    ...
    public class PlayerStatJsonConverter : JsonConverter<PlayerStat>
    {
        ...
        public override PlayerStat Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!position.IsSet)
                throw new ArgumentException("Property is required for class PlayerStat.", nameof(position));
            ...
            if (position.IsSet && position.Value == null)
                throw new ArgumentNullException(nameof(position), "Property is not nullable for class PlayerStat.");
            ...
            return new PlayerStat(season.Value!.Value!, playerId.Value!, player.Value!, position.Value!, team.Value!, conference.Value!, category.Value!, statType.Value!, stat.Value!);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, PlayerStat playerStat, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (playerStat.Position == null)
                throw new ArgumentNullException(nameof(playerStat.Position), "Property is required for class PlayerStat.");
            ...
            writer.WriteString("position", playerStat.Position);
