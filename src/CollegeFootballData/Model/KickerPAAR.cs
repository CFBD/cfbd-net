...
namespace CollegeFootballData.Model
{
    ...
    public partial class KickerPAAR : IValidatableObject
    {
        ...
        /// <param name="paar">paar (required).</param>
        /// <param name="attempts">attempts (required).</param>
        public KickerPAAR(int year = default(int), string athleteId = default(string), string athleteName = default(string), string team = default(string), string conference = default(string), double paar = default(double), int attempts = default(int))
        {
            this.Year = year;
            // to ensure "athleteId" is required (not null)
            if (athleteId == null)
            {
                throw new ArgumentNullException("athleteId is a required property for KickerPAAR and cannot be null");
            }
            this.AthleteId = athleteId;
            // to ensure "athleteName" is required (not null)
            if (athleteName == null)
            {
                throw new ArgumentNullException("athleteName is a required property for KickerPAAR and cannot be null");
            }
            this.AthleteName = athleteName;
            // to ensure "team" is required (not null)
            if (team == null)
            {
                throw new ArgumentNullException("team is a required property for KickerPAAR and cannot be null");
            }
            this.Team = team;
            // to ensure "conference" is required (not null)
            if (conference == null)
            {
                throw new ArgumentNullException("conference is a required property for KickerPAAR and cannot be null");
            }
        ...
        /// Gets or Sets Paar
        /// </summary>
        [DataMember(Name = "paar", IsRequired = true, EmitDefaultValue = true)]
