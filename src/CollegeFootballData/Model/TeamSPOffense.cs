...
namespace CollegeFootballData.Model
{
    ...
    public partial class TeamSPOffense : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TeamSPOffense(double rating, int ranking, double? pace = default, double? runRate = default, double? passingDowns = default, double? standardDowns = default, double? passing = default, double? rushing = default, double? explosiveness = default, double? success = default)
        {
            Rating = rating;
            Ranking = ranking;
            Pace = pace;
    ...
    public class TeamSPOffenseJsonConverter : JsonConverter<TeamSPOffense>
    {
        ...
        public override TeamSPOffense Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (ranking.IsSet && ranking.Value == null)
                throw new ArgumentNullException(nameof(ranking), "Property is not nullable for class TeamSPOffense.");

            return new TeamSPOffense(rating.Value!.Value!, ranking.Value!.Value!, pace.Value!, runRate.Value!, passingDowns.Value!, standardDowns.Value!, passing.Value!, rushing.Value!, explosiveness.Value!, success.Value!);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, TeamSPOffense teamSPOffense, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteNumber("ranking", teamSPOffense.Ranking);
