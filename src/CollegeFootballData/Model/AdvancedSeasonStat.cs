...
namespace CollegeFootballData.Model
{
    ...
    /// AdvancedSeasonStat
    /// </summary>
    [DataContract(Name = "AdvancedSeasonStat")]
    public partial class AdvancedSeasonStat : IValidatableObject
    {
        ...
        public AdvancedSeasonStat(int season = default(int), string team = default(string), string conference = default(string), AdvancedSeasonStatOffense offense = default(AdvancedSeasonStatOffense), AdvancedSeasonStatDefense defense = default(AdvancedSeasonStatDefense))
        {
            ...
            if (team == null)
            {
                throw new ArgumentNullException("team is a required property for AdvancedSeasonStat and cannot be null");
            }
            this.Team = team;
            // to ensure "conference" is required (not null)
            if (conference == null)
            {
                throw new ArgumentNullException("conference is a required property for AdvancedSeasonStat and cannot be null");
            }
            this.Conference = conference;
            // to ensure "offense" is required (not null)
            if (offense == null)
            {
                throw new ArgumentNullException("offense is a required property for AdvancedSeasonStat and cannot be null");
            }
            this.Offense = offense;
            // to ensure "defense" is required (not null)
            if (defense == null)
            {
                throw new ArgumentNullException("defense is a required property for AdvancedSeasonStat and cannot be null");
            }
