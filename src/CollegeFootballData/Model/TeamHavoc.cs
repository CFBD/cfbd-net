...
namespace CollegeFootballData.Model
{
    ...
    public partial class TeamHavoc : IValidatableObject
    {
        ...
        public TeamHavoc(string team = default(string), double total = default(double), double frontSeven = default(double), double db = default(double))
        {
            // to ensure "team" is required (not null)
            if (team == null)
            {
                throw new ArgumentNullException("team is a required property for TeamHavoc and cannot be null");
            }
            this.Team = team;
            this.Total = total;
