...
namespace CollegeFootballData.Model
{
    ...
    public partial class TeamSP : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TeamSP(int year, string team, string conference, double rating, TeamSPOffense offense, TeamSPDefense defense, TeamSPSpecialTeams specialTeams, int? ranking = default, double? secondOrderWins = default, double? sos = default)
        {
            Year = year;
            Team = team;
    ...
    public class TeamSPJsonConverter : JsonConverter<TeamSP>
    {
        ...
        public override TeamSP Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new TeamSP(year.Value!.Value!, team.Value!, conference.Value!, rating.Value!.Value!, offense.Value!, defense.Value!, specialTeams.Value!, ranking.Value!, secondOrderWins.Value!, sos.Value!);
        }
