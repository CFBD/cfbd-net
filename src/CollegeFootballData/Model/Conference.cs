...
namespace CollegeFootballData.Model
{
    ...
    public partial class Conference : IValidatableObject
    {
        ...
        public Conference(int id = default(int), string name = default(string), string shortName = default(string), string abbreviation = default(string), DivisionClassification classification = default(DivisionClassification))
        {
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for Conference and cannot be null");
            }
            this.Name = name;
            // to ensure "shortName" is required (not null)
            if (shortName == null)
            {
                throw new ArgumentNullException("shortName is a required property for Conference and cannot be null");
            }
            this.ShortName = shortName;
            // to ensure "abbreviation" is required (not null)
            if (abbreviation == null)
            {
                throw new ArgumentNullException("abbreviation is a required property for Conference and cannot be null");
            }
