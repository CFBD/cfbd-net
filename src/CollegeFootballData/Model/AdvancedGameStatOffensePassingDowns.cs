...
namespace CollegeFootballData.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AdvancedGameStat_offense_passingDowns")]
    public partial class AdvancedGameStatOffensePassingDowns : IValidatableObject
    {
        ...
        protected AdvancedGameStatOffensePassingDowns() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedGameStatOffensePassingDowns" /> class.
        /// </summary>
        ...
        public AdvancedGameStatOffensePassingDowns(double explosiveness = default(double), double successRate = default(double), double ppa = default(double))
        {
