...
namespace CollegeFootballData.Model
{
    ...
    public partial class TeamSPDefense : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TeamSPDefense(AdvancedSeasonStatOffenseHavoc havoc, double rating, int ranking, double? passingDowns = default, double? standardDowns = default, double? passing = default, double? rushing = default, double? explosiveness = default, double? success = default)
        {
            Havoc = havoc;
            Rating = rating;
            Ranking = ranking;
    ...
    public class TeamSPDefenseJsonConverter : JsonConverter<TeamSPDefense>
    {
        ...
        public override TeamSPDefense Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (ranking.IsSet && ranking.Value == null)
                throw new ArgumentNullException(nameof(ranking), "Property is not nullable for class TeamSPDefense.");

            return new TeamSPDefense(havoc.Value!, rating.Value!.Value!, ranking.Value!.Value!, passingDowns.Value!, standardDowns.Value!, passing.Value!, rushing.Value!, explosiveness.Value!, success.Value!);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, TeamSPDefense teamSPDefense, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteNumber("ranking", teamSPDefense.Ranking);
